...
- A live map where nearby reports of the same problem cluster into one pin, color-coded by status and colored redder the more people have complained
...
- Multi-photo uploads, tap-to-zoom, shareable permalinks to any single issue
...
- Post progress updates with photos that citizens see immediately, or keep a note internal-only for staff coordination
